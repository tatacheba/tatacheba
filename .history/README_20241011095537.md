...
Hi! My name is Tatiana Chetobaru and I am looking for a job in the field of testing automation. QA engineer with 3 years of experience in testing, specialized in manual testing web, desktop and mobile applications, have basic knowledge of automation. I have experience in creating and running test cases, testing the database with Fiddler and Postman. Preparing bug reports. Proficient in languages (Java, JavaScript) and frameworks (Gradle, Appium, Selenide, JUnit5, REST Assured, React, Vue), as well as CI/CD tools (Allure, Docker, Jenkins, GitHub). Strive to develop in automation testing.
